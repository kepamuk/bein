<template>
  <div class="home">
    <button
      class="go-back"
      @click.prevent="$store.dispatch('changeMenuState', true)"
      type="button"
    >
    ...
    <div class="home__content">
      <div
        class="xrp_block card card--gradient row-flex align-items-center justify-content-between"
      >
        <div class="balance">
      ...
      <div
        class="card usdx_block card--gradient-purple row-flex align-items-center justify-content-between"
      >
        <div class="balance">
          <div class="balance__icon">
      ...
      <div class="transactions transactions_block">
        <div
          class="transactions__header row-flex align-items-center justify-content-start mb15 mt15"
        >
