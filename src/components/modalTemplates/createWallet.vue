    ...
    >
      <div class="beModal__body">
        ...
        <div class="step step__content" :class="{ active: currentstep == 2 }">
          ...
          <p>
            To activate your wallet, you need to send 20 XRP to your new Ripple
            account. Once your wallet is replenished with 20 XRP, it will be
            automatically activated
          </p>
        </div>
        <div class="step step__content" :class="{ active: currentstep == 3 }">
          <h4 class="step__title mb40">
            Write down your secret phrase in the correct order on а paper
          </h4>
          ...
          <button @mousedown="downEvent()" @mouseup="upEvent()">
            <strong :class="clickedButton ? 'text--primary50' : 'text--primary'"
              >Press and Hold to Reveal</strong
            >
          </button>
        </div>
      </div>
      <div class="beModal__footer">
        ...
        <beButton
          ...
          @click="nextStep"
        ></beButton>
        <p v-if="currentstep == 3" class="mt30 text-info">
          Do not create a digital copy such as a screenshot, text file or
          e-mail.
        </p>
      </div>
    </vueCustomScrollbar>
    ...
    submitData() {
      ...
      this.$modal.show(
        transactionsSend,
        {
          ...
          successText:
            'Your wallet has been created and added to "My Wallets". You can get detailed information on transactions by clicking on the wallet.',
        },
