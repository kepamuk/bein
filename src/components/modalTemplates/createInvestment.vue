  ...
  <div class="create_investment beModal">
    ...
    >
      ...
      <div class="info_block">
        ...
        <p>
          <i class="icon-ticket text--primary"></i> You will receive
          <span class="text--primary">122 giveaway tickets</span>
        </p>
      </div>
      <div class="beModal__footer">
        <beButton title="Invest" class="full-width" :shadow="true"> </beButton>
      </div>
    </vueCustomScrollbar>
  </div>
</template>
...
.rejected_earnings {
  padding: 30px 55px;
  border: none;
  border-top: 2px dashed rgba(#0b111a, 0.5);
  border-bottom: 2px dashed rgba(#0b111a, 0.5);
  @media (max-width: 767px) {
    padding: 30px 30px;
  }
  &__title {
    color: rgba(#0b111a, 0.7);
    font-weight: 500;
  }
  &__value {
    font-size: 36px;
