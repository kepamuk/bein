<template>
  <div class="">
    <div id="buttons" class="card mb30 card--gradient">
      <beButton type="submit" title="Вывод" :outline="true" :white="true"
        ><i class="icon-sign-out" slot="icon-left"></i
      ></beButton>
      <beButton type="button" title="Вывод" :outline="false" :white="true"
        ><i class="icon-sign-out" slot="icon-left"></i
      ></beButton>
      <beButton
        type="button"
      ...
      ></beButton>
      <br />
      <beButton type="button" title="Ввод" :outline="true" :white="true"
        ><i class="icon-sign-in" slot="icon-left"></i
      ></beButton>
      <beButton type="button" title="Ввод" :outline="false" :white="true"
        ><i class="icon-sign-in" slot="icon-left"></i
      ></beButton>
      <beButton
        type="button"
