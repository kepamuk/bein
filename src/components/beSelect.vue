<template>
  <div
    class="select"
    :class="{ select__shadow: shadow, select__transparent: transparent }"
    ref="select"
  >
    <div
      class="select__value"
      :class="{ icon_left: sortingIcon || refreshIcon }"
      @click="toggleSelectFocus"
    >
      ...
      <span
        v-if="dropdownIcon"
        class="select__dropdown_icon"
        :class="{ active: selectFocused }"
      ...
      <div class="select__dropdown" v-if="selectFocused">
        ...
        >
          <ul>
            ...
            <li class="select__dropdown_item">
  ...
  &:not(.select__transparent) {
    .select__dropdown {
      ...
      &_item {
        ...
        &:hover {
          background-color: rgba(#0b111a, 0.05);
        }
        &.checked {
          background-color: rgba(#0b111a, 0.08);
        }
      }
    }
